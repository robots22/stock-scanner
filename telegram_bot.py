...
# ==================== GLOBALNE STANY (współdzielone z main.py) ====================
...
def start_bot_thread():
    """Uruchamia bota w osobnym wątku — interfejs dla main.py"""
    # Używane gdy main.py importuje start_bot_thread zamiast TelegramBot
    # W tej wersji bota główna klasa to TelegramBot — start_bot_thread
    # jest tylko stub dla kompatybilności z v2.0
    logger.info("start_bot_thread: użyj TelegramBot(scanner).start() zamiast tego")
